...
const projects = [
  {
    ...
    category: "Рестораны",
    desc: "Итальянский ресторан с онлайн-бронированием и меню",
    tags: ["Онлайн-запись", "ЮKassa", "Метрика"],
    color: "from-orange-500 to-red-600",
    stats: { visitors: "2 400", conversion: "8.2%" },
  },
  {
    id: 2,
    title: "Клиника Здоровья",
    category: "Медицина",
    desc: "Медицинский центр с записью к врачу и оплатой",
    tags: ["Запись к врачу", "Robokassa", "Яндекс Бизнес"],
    color: "from-blue-500 to-cyan-400",
    stats: { visitors: "5 100", conversion: "12.4%" },
  },
  {
    id: 3,
    title: "Академия Pro",
    category: "Образование",
    desc: "Онлайн-школа с продажей курсов и сертификатами",
    tags: ["Курсы", "ЮKassa", "Аналитика"],
    color: "from-purple-500 to-violet-600",
    stats: { visitors: "8 700", conversion: "6.8%" },
  },
  {
    id: 4,
    title: "CleanMaster",
    category: "Услуги",
    desc: "Клининговая компания с онлайн-расчётом стоимости",
    tags: ["Калькулятор", "Telegram Bot", "Метрика"],
    color: "from-green-500 to-emerald-600",
    stats: { visitors: "1 200", conversion: "15.3%" },
  },
  {
    id: 5,
    title: "МодаПлюс",
    category: "Интернет-магазин",
    desc: "Магазин одежды с каталогом и корзиной покупок",
    tags: ["Каталог", "Robokassa", "Яндекс Бизнес"],
    color: "from-pink-500 to-rose-600",
    stats: { visitors: "11 300", conversion: "4.1%" },
  },
  {
    id: 6,
    title: "FitLife Studio",
    category: "Услуги",
    desc: "Фитнес-студия с расписанием и абонементами",
    tags: ["Расписание", "ЮKassa", "Google Analytics"],
    color: "from-yellow-500 to-orange-500",
    stats: { visitors: "3 500", conversion: "9.7%" },
  },
  {
    id: 7,
    title: "Зубная Фея",
    category: "Медицина",
    desc: "Стоматология с онлайн-записью и отзывами пациентов",
    tags: ["Онлайн-запись", "Яндекс Бизнес", "Метрика"],
    color: "from-teal-400 to-cyan-600",
    stats: { visitors: "4 200", conversion: "11.1%" },
  },
  {
    id: 8,
    title: "Пиццерия Дон",
    category: "Рестораны",
    desc: "Доставка пиццы с конструктором заказа и трекингом",
    tags: ["Доставка", "Robokassa", "Telegram Bot"],
    color: "from-red-500 to-orange-600",
    stats: { visitors: "6 800", conversion: "18.5%" },
  },
  {
    id: 9,
    title: "КидсЛэнд",
    category: "Образование",
    desc: "Детский развивающий центр с расписанием занятий",
    tags: ["Расписание", "ЮKassa", "Аналитика"],
    color: "from-violet-500 to-purple-700",
    stats: { visitors: "2 900", conversion: "10.2%" },
  },
];
      ...
      <section className="gradient-hero pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-white mb-6 font-['Manrope']">
            Сайты, которые{" "}
            <span className="gradient-text">работают</span>
          </h1>
            ...
            {filtered.map((project) => (
              <div key={project.id} className="glass rounded-2xl overflow-hidden card-hover group">
                <div className={`h-48 bg-gradient-to-br ${project.color} relative flex items-center justify-center`}>
                  <div className="text-white text-6xl font-black opacity-20 font-['Manrope']">
                    {project.title[0]}
                  </div>
                  <div className="absolute top-4 right-4 glass rounded-lg px-3 py-1 text-white/80 text-xs">
                    {project.category}
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.map((tag) => (
                      <span key={tag} className="px-2 py-1 rounded-lg bg-purple-500/20 text-purple-300 text-xs">
                        {tag}
                      </span>
                    ))}
                  </div>
